...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="controles">
        <div class="conteiner">
            ...
            <h4>Cpanel</h4>
            <hr />
            <button id="btnModelos" runat="server" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#ModalNovoModelo" data-whatever="@mdo">Novo Modelo</button>
            <button id="btnSintomas" runat="server" class="btn btn-success btn-lg" data-toggle="modal" data-target="#ModalNovoSintomas" data-whatever="@mdo">Novo Sintoma</button>
            <button id="btnBlock" runat="server" class="btn btn-info btn-lg" data-toggle="modal" data-target="#ModalNovoBlock" data-whatever="@mdo">Nova Linha</button>
        ...
        <div class="modal fade" id="ModalNovoSintomas" tabindex="-1" role="dialog" aria-labelledby="ModelSintomas">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="Sintomas">Novo Sintoma</h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label for="recipient-name" class="control-label">Sintoma:</label>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="recipient-name" class="control-label">Linha:</label>
