   ...
   <%-- <h2><%: Title %>.</h2>--%>
    ...
    <div class="form-horizontal ContainerNovoUsuario">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            <label for="funcao" class="col-md-2 control-label">FUNCTION</label>
            <div class="col-md-10">
        ...
        <div class="form-group">
            <label for="predio" class="col-md-2 control-label">Building</label>
            <div class="col-md-10">
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                ...
                <span class="glyphicon glyphicon-plus"> Register</span>
                </asp:LinkButton>
