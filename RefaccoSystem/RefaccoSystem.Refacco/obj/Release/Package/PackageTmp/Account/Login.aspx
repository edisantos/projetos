<%@ Page Title="Logon" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="RefaccoSystem.Refacco.Account.Login" Async="true" %>
                    ...
                    <div class="form-horizontal formLogin">
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-10">
                                ...
                                <asp:LinkButton runat="server" OnClick="LogIn" CssClass="btn btn-success">
