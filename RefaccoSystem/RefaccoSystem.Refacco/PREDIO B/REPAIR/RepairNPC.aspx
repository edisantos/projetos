<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RepairNPC.aspx.cs" Inherits="RefaccoSystem.Refacco.PREDIO_B.REPAIR.RepairNPC" %>
                    ...
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-striped gdv" AutoGenerateColumns="false">
                        <Columns>
                           ...
                           <asp:TemplateField HeaderText="Id">
                            ...
                            <asp:TemplateField HeaderText="Tempo de Reparo">
                                <ItemTemplate>
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <asp:Label ID="lblStatusFinally" runat="server" Visible="false"></asp:Label>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            ...
                            <div class="form-group">
                                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                    <ContentTemplate>
                                        <label for="un">Envio Reparo:</label>
