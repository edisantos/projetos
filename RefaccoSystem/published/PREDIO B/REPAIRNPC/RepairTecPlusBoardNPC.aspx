<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RepairTecPlusBoardNPC.aspx.cs" Inherits="RefaccoSystem.Refacco.PREDIO_B.REPAIRNPC.RepairTecPlusBoardNPC" %>
        ...
        <div id="GridRigisterBoard">
            ...
            <div id="boxButton">
                ...
                <div class="alert alert-info" role="alert">
                    <span class="glyphicon glyphicon-pencil">Registro Técnico + Placa</span>
                </div>
            </div>
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                <ContentTemplate>
                    <div class="form-inline">
                        ...
                        <span class="glyphicon glyphicon-plus"> Registrar All</span>
                            </asp:LinkButton>
                        </div>
                        <div class="form-group">
                ...
                <ContentTemplate>
                    ...
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-striped gdv" AutoGenerateColumns="false">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Id" HeaderStyle-CssClass="gdv">
                                <ItemTemplate>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <asp:LinkButton ID="btnSalve" runat="server" CssClass="btn btn-primary" OnClick="btnSalve_Click">
                                <span class="glyphicon glyphicon-floppy-saved"> Registro</span>
                        </asp:LinkButton>
