                    ...
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-striped gdv" AutoGenerateColumns="false">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Sintoma">
                                <ItemTemplate>
                                    <asp:Label ID="lblSintoma" runat="server" Text='<%#Eval("Sintomas") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Timpo de Analise">
                                <ItemTemplate>
                                    <asp:Label ID="lblTimeTecnico" runat="server" Text='<%#Eval("TimeTecnico") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Timppo de Reparo">
                                <ItemTemplate>
