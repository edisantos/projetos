<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterBoardPlusTec.aspx.cs" Inherits="RefaccoSystem.Refacco.PREDIO_A.SMD.RegisterBoardPlusTec.RegisterBoardPlusTec" %>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                         ...
                         <%--<div class="form-group">
                            <label for="All" runat="server">ALL</label>
                            <asp:CheckBox id="ckbAll" runat="server" OnCheckedChanged="ckbAll_CheckedChanged" />
                        </div>--%>
                        <div class="form-group">
