            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <div class="form-horizontal formulario">
                        ...
                        <br />
                        <div class="form-group">
                            <label class="control-label col-md-2" for="massa">Save in bulk:</label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-2" for="cn">Cod Fail:</label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-2" for="cn">Symptoms:</label>
                            <div class="col-md-10">
