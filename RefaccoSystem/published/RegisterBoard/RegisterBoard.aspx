...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div id="ContainerRegisterBoard">
        ...
        <div id="GridRigisterBoard">
            <h2>Lista de Placas para relacionamento com o Técnico</h2>
            <p class="text-danger">
            ...
            <div id="boxButton">
                ...
                <div class="alert alert-info" role="alert">
                    <span class="glyphicon glyphicon-pencil">Formulário para relacionar o Técnico com a placa</span>
                </div>
            </div>
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                <ContentTemplate>
                    <div class="form-inline">
                        ...
                        <div class="form-group">
                            <asp:LinkButton ID="btnRegTecMassa" runat="server" CssClass="btn btn-primary" data-toggle="modal" data-target="#myModal">
                        <span class="glyphicon glyphicon-pencil"> Register All</span>
                            </asp:LinkButton>
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">REGISTER TECHNICAN + BOARD</h4>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="tecnico" runat="server">Responsible technician</label>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-default" data-dismiss="modal">
                            <span class="glyphicon glyphicon-level-up">Close</span>
                        </button>
